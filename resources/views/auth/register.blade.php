			...
			<div class="card">
				...
				<div class="card-body">
					<form method="POST" action="{{ route('register') }}">
						...
						<div class="row mb-3">
							<label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Tipo de documento')
								}}</label>
							...
							<div class="col-md-6">
								<select class="form-control col-md-6">
									...
									<option value="3">Cedula Digital</option>
									<option value="4">Pasaporte</option>
								</select>
							</div>
						</div>
						<div class="row mb-3">
							<label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Numero documento')
								}}</label>
